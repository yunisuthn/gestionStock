...
export class EditS extends React.Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:8800/article/'+this.props.match.params._id)
        .then(response => {
  ...
  onSubmit(e) {
    ...
    console.log('persone ============== ', this.state.nomPiece);
    
    axios.put('http://localhost:8800/article/'+this.props.match.params._id, obj)
